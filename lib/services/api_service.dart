  ...
  class ApiService {
    ...
    static const String _baseUrl = kIsWeb ? 'http://localhost:8080' : 'http://10.117.89.92:8080';   // run on docker and run on phone
    ...
    static const String websocketUrl = kIsWeb ? 'ws://localhost:8080/ws' : 'ws://10.117.89.92:8080/ws';
