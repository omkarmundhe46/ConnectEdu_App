  ...
  class ApiService {
    ...
    static const String _baseUrl = kIsWeb ? 'http://localhost:8080' : 'http://172.20.123.92:8080';   // run on docker and run on phone
    ...
    static const String websocketUrl = kIsWeb ? 'ws://localhost:8080/ws' : 'ws://172.20.123.92:8080/ws';
